...
local DiagnosticHint = "󰌵"
local DiagnosticInfo = "󰋼"
...
local GitUnstaged = "✗"
local GitUntracked = "★"
local LSPLoaded = "" -- TODO: Remove unused icon in AstroNvim v4
local LSPLoading1 = ""
local LSPLoading2 = "󰀚"
local LSPLoading3 = ""
...
local catppuccin_window_left_separator = "█"
local catppuccin_window_right_separator = "█ "

local GLYPH_SEMI_CIRCLE_LEFT = catppuccin_window_left_separator
--local GLYPH_SEMI_CIRCLE_LEFT = utf8.char(0xe0b6)
local GLYPH_SEMI_CIRCLE_RIGHT = catppuccin_window_right_separator
